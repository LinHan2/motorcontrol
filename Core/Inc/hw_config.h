...
#define V_BUS_MAX			40.0f//40.0f			// max drive voltage (faults above this)

/* Current controller 修改这些参数*/
#define L_D .00004f				// D axis inductance
#define L_Q .00004f				// Q axis inductance
#define K_D .8f                    // Loop gain,  Volts/Amp
#define K_Q .8f                    // Loop gain,  Volts/Amp
#define K_SCALE 0.00012f             // K_loop/Loop BW (Hz) 0.0042
#define KI_D 0.36f                // PI zero, in radians per sample,默认0.045f
#define KI_Q 0.36f                // PI zero, in radians per sample
